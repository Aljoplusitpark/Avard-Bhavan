                    ...
                    <div class="card-body">
                      <form method="post" action="blog_action.php" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" name="name" placeholder="Enter Banner Title" />
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Profile</label>
                          <div class="col-sm-10">
                            <input type="file" class="form-control" id="basic-default-name" name="image" placeholder="Enter Banner Title" />
                          </div>
                        </div>
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo ' <tr>
                                            ...
                                            <td>'.$rows['title'].'</td>
                                            <td>'.$string.'</td>
                                            <td><img style="width: 50px; height: 50px;" src="Files/profile_blog/'.$rows['image'].'" alt="Avatar" class="rounded-circle" /></td>';
                                            

                                      
                                      
                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_blog.php?cat_del=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;'><i class='fa fa-trash'></i></a>";


                                     echo   '<a href="update_blog.php?upd='.$rows['id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5" style="font-size:15px; margin-left:5px; padding:5px;" ><i class="fa fa-edit" ></i></a>
                                            </td></tr>';
                                            $i++;
                                      } 

                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo ' <tr>
                                            ...
                                            <td><img style="width: 50px; height: 50px;" src="Files/banner/'.$rows['image'].'" alt="Avatar" class="rounded-circle" /></td>
                                            ';
                                            

                                      
                                      
                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_banner.php?cat_del=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;'><i class='fa fa-trash'></i></a>";


                                     echo   '<a href="update_banner.php?upd='.$rows['id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5" style="font-size:15px; margin-left:5px; padding:5px;" ><i class="fa fa-edit" ></i></a>
                                            </td></tr>';
                                            $i++;
                                      } 

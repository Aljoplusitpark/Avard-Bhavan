                                ...
                                if(!mysqli_num_rows($result) > 0 )
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_subscribe.php?cat_del=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;'><i class='fa fa-trash'></i></a></td></tr>";
